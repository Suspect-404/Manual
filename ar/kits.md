...
* ![](../assets/kit_icons/kit_grenadier_outline.png)**Grenadier**: يُسمح بوجود عدة (Kit) واحدة فقط من هذا النوع في كل فرقة (Squad)، وبحد أقصى 8 عدات (Kits) في الفريق (Team). تُجهَّز عادةً بقاذف قنابل يُثبَّت أسفل البندقية الهجومية. تتمثل مهمتها الأساسية في قصف المناطق ذات الرؤية المحدودة التي يُشتبه بوجود الأعداء فيها، بالإضافة إلى مضايقة المركبات الخفيفة وإضعافها. وتُعد هذه العدة فعالة بشكل خاص في الاشتباكات بعيدة المدى، وكذلك عند التعامل مع الأعداء المتحصنين داخل المباني.
