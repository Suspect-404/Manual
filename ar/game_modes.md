...
لعرض حالة التقدم في السيطرة، يجب أن تكون موجودًا فعليًا داخل نطاق نقطة التحكم كما هو موضح على الخريطة، ثم تضغط على زر عرض قائمة اختيار الكِت/الفرقة (Caps Lock) أو مفتاح الخريطة (M).
