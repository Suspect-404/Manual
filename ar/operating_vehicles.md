...
* لم يعد بالإمكان استخدام منظور الرؤية الخارجي للمركبات. ومع ذلك، زُوِّدت بعض المركبات بكاميرات خاصة، مثل الشاحنات التي توفر رؤية خلفية، وسيارات الجيب المزودة بمرايا جانبية يمكن استخدامها بالضغط على زر **(C)**.
...
* تستخدم الرشاشات المثبتة على المركبات أحزمة ذخيرة ذات سعة محدودة، ويمكن إعادة تلقيمها بالضغط على زر **(R)** افتراضيًا.
...
* يمكنك استخدام زر **Left Ctrl** مع تحريك الفأرة للنظر بحرية أثناء تشغيل معظم المركبات، مثل المروحيات والطائرات النفاثة وسيارات الجيب والقوارب والشاحنات. أما ناقلات الجنود المدرعة (APCs) ومركبات المشاة القتالية (IFVs)، فلا تدعم هذه الميزة لأنها تستخدم كاميرات مخصصة.
* في الخوادم العامة (وليس عند اللعب محليًا)، يمكنك الانتقال بسرعة إلى المقعد المتاح التالي داخل المركبة بالضغط على زر (F8).
...
* يستطيع سائقو الدبابات، وسائقو بعض ناقلات الجنود المدرعة (APCs) ومركبات المشاة القتالية (IFVs)، استخدام وضع رؤية القائد، الذي يوفر مجال رؤية بزاوية 360° حول البرج. ويمكن الوصول إلى هذا الوضع بالضغط على زر (2).
* يمكن للسائقين والرامين تكبير مجال الرؤية بالضغط على زر (X). وفي بعض الدبابات، يجب على السائق أولًا التبديل إلى وضع رؤية القائد.
...
* يمكن لرامي المروحيات الهجومية تكبير كاميرا التصويب بالضغط على زر تبديل الكاميرا **(C)** أو باستخدام المفاتيح من F9 إلى F11. كما يمكنه التبديل إلى وضع الرؤية الحرارية بفتح قائمة الراديو الثانوية **(T)** ثم اختيار **«DAY / THERMAL»** للتبديل بين وضعي الرؤية العادية والحرارية.
...
* تتميز الشعلات الحرارية (Flares) المستخدمة كإجراءات مضادة بعدد محدود، ويجب إعادة تزويد المروحية بها بعد نفادها. وفي كل مرة تطلق فيها الشعلات الحرارية بالضغط على زر (X)، تُطلق شعلة واحدة فقط.
...
* تحتوي معظم الطائرات النفاثة على **مقاعد قذف**، وهي مقاعد تقذف الطيار خارج الطائرة في حالات الطوارئ. ويمكن استخدامها بالضغط على زر E. وعند انخفاضك إلى أقل من 750 مترًا، تُفتح المظلة تلقائيًا. 
...
* لا تحتوي الطائرات على كاميرا أمامية في المقدمة، ولكن يمكنك مع ذلك النظر إلى الخلف باستخدام زر تبديل الكاميرا **(C)** أو زر F11. وللعودة إلى النظر للأمام، اضغط على زر F9 أو استخدم زر لاستخدلم أي سلاح.
* تُطلق **الشعلات الحرارية (Flares)** بشكل فردي عند الضغط على زر **(X)**، ويجب إعادة تزويدها بالشعلات الحرارية بعد نفادها. وبما أن صوت التحذير لا يصدر إلا بعد أن يتمكن العدو من تثبيت القفل على طائرتك لمدة نصف ثانية، يُنصح باستخدامها أثناء تنفيذ هجوم لتقليل فرصة تمكن العدو من تثبيت القفل عليك.
...
* يختلف منظار الرامي (علامة التصويب الظاهرة على شاشة العرض) من مركبة إلى أخرى بحسب تجهيزاتها. فبعض المركبات، وخاصة الأقدم منها - وإن لم يكن ذلك مرتبطًا بالعمر دائمًا - لا توفر سوى شبكة تصويب تحتوي على خطوط وتدريجات تُستخدم لتحديد نقطة التصويب المناسبة وفقًا لمسافة الهدف.
...
* بعد توجيه علامة التصويب نحو الهدف، يمكن في المركبات المزوّدة بمحدد مدى ليزري قياس المسافة إلى الهدف بالضغط على زر تبديل الكاميرا **(C افتراضيًا)**. بعد ذلك، يضبط النظام سبطانة السلاح تلقائيًا على الزاوية المناسبة، بحيث تصيب القذيفة النقطة التي تشير إليها علامة التصويب. 
