...
* يمكن طلب الكتات من قائمة الظهور/Spwan الرئيسية (الزر الافتراضي: Caps Lock)، أو من صندوق الإمدادات [راجع: اللوجستيات]((the_basics.md#logistics)\))، أو من الجزء الخلفي لناقلة جنود مدرعة (APC) أو مركبة قتال مشاة (IFV). ولكي تتمكن من طلب كت من صندوق إمدادات أو من مركبة، يجب أن تكون عضوًا في فرقة.

في PR:BF2، لا يمكنك الظهور/Spwan عند جميع نقاط السيطرة التي يسيطر عليها فريقك. وتتمثل نقاط الظهور/Spwan المتاحة في PR:BF2 فيما يلي:

* **نقطة الظهور الخاصة بفرقتك (Rally Point أو RP)** تُعرض على شكل دائرة خضراء تحيط بنقطة ظهور/Spwan، وبجوارها رقم فرقتك. ويعتمد بقاؤها على موقعها بالنسبة إلى قاعدة العمليات الأمامية (FOB) التابعة لفريقك. ملاحظة: لا يمكنك الظهور/Spwan عند Rally Point الخاصة بفرقة أخرى. فإذا حاولت اختيارها، فستظهر تلقائيًا عند Rally Point الخاصة بفرقتك، أو عند أقرب FOB متاحة. وإذا لم تكن أي منهما متوفرة، فستظهر في القاعدة الرئيسية لفريقك. وإذا اجتاح العدو نقطة تجمع فرقتك، فستختفي ولن تعود متاحة للظهور. كما أن نقاط التجمع (RP) ليست متوفرة لدى جميع الفصائل. [راجع قسم: المنشآت القابلة للبناء](the_squad_leader.md#deployable-structures)

{% figure "../assets/rally.png" %}
 نقطة تجمع (Rally Point).
{% endfigure %}

* **نقاط التجمع (Rally Point) الخاصة بالفريق، والتي تختلف حسب الخريطة**. تكون متاحة عادةً لمدة 5 دقائق بعد بداية الجولة، ويمكن لجميع أفراد الفريق استخدامها للظهور/Spwan. وتختفي بعد أن يظهر عندها 12 لاعبًا كحد أقصى.
...
* **قواعد العمليات الأمامية (FOBs) أو المخابئ القابلة للبناء (Hideout)** يمكن لجميع أفراد الفريق استخدامها كنقاط ظهور/Spawn، لكنها لا تصبح جاهزة للاستخدام إلا بعد بنائها. وتظهر على الخريطة كنقطة ظهور/Spawn تحمل مثلثًا أخضر، وتصبح جاهزة للعمل بعد 90 ثانية من اكتمال بنائها. وتصبح غير متاحة للظهور/Spawn لمدة 30 ثانية إذا وُجد عدو واحد ضمن 10 أمتار، أو عدوان ضمن 50 مترًا، أو أربعة أعداء ضمن 100 متر، أو ثمانية أعداء ضمن 150 مترًا. [راجع قسم: المنشآت القابلة للبناء](the_squad_leader.md#deployable-structures)
* في طور Insurgency، يستطيع الفريق المدافع من المتمردين الظهور/Spawn عند **مخابئ الأسلحة (weapons caches)** التي لم يكتشفها العدو بعد، وتُعرف هذه المخابئ باسم المخبأ المجهول (Unknown Cache). كما تصبح نقطة الظهور/Spawn هذه غير متاحة إذا اقترب منها الأعداء أكثر من اللازم، تمامًا كما هو الحال مع FOB.
...
* **مقر فريقك، أو القاعدة الرئيسية، أو قاعدة العمليات الأمامية الدائمة (Permanent FOB)**. وهي نقطة الظهور/Spawn الوحيدة المتاحة دائمًا.

{% figure "../assets/acv.png" %}
مركبة القيادة المدرعة (ACV)، وتوجد في القواعد الرئيسية فقط.
{% endfigure %}

* تتضمن بعض الخرائط **نقاط ظهور بالمظلات**، لمحاكاة عمليات الإنزال الجوي. وتظهر هذه النقاط على الخريطة المصغرة على هيئة علامات ظهور/Spawn متحركة. اختر إحداها، وستظهر في ساحة المعركة بمظلة تُفتح تلقائيًا.
...
في بعض الحالات، لا يكون إنعاش اللاعب ممكنًا، مثلًا إذا قُتل داخل مركبة. كذلك، إذا أُنعشت ثم أُصبت إصابةً حرجة مرة أخرى خلال دقيقتين، فلن يكون بالإمكان إنعاشك للمرة الثانية. وإذا بقيت في حالة الإصابة الحرجة دون إنعاش لمدة 5 دقائق، فستُعتبر ميتًا نهائيًا. إذا لم يعد هناك أي أمل في إنعاشك، فاضغط على زر **"Give Up"** في شاشة الظهور/Spawn. عندها ستظهر رسالة تفيد بأنك ميت، ويمكنك الاستعداد للظهور/Spawn من جديد. ويُحتسب الوقت الذي قضيته في انتظار الضغط على Give Up ضمن إجمالي وقت إعادة الظهور/Spawn.

### إعادة الظهور (Spawn)

يتراوح وقت إعادة ظهور/Spawn اللاعب بين 45 و60 ثانية، وقد يزداد بسبب عقوبات مؤقتة. ويُخصم من هذا الوقت مقدار ما قضيته في انتظار المسعف. وبعد الموت، يجب أن تنتظر 5 ثوانٍ على الأقل قبل أن تتمكن من الظهور/Spawn من جديد. وتؤثر الإجراءات التالية في مدة إعادة الظهور/Spawn:
...
تضيف الإجراءات التالية عقوبة مؤقتة إلى وقت إعادة الظهور/Spawn، ولا تؤثر إلا في إعادة ظهورك/Spawn التالية (بحد أقصى 5 دقائق):
...
لاختيار نقطة ظهور/Spawn، افتح خريطة الظهور/Spawn **(الزر الافتراضي: Enter)**، ثم اختر موقعًا متاحًا مميزًا بنقطة بيضاء. وبعد اختيار نقطة الظهور/Spawn المناسبة، اضغط على زر **Spawn** الموجود في الزاوية السفلية اليمنى من شاشة الخريطة للعودة إلى اللعبة.
